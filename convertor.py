...
js_code += "\n"
js_code += "        // 期中成绩（置空）\n"
js_code += "        const midtermTbody = document.getElementById('midterm-tbody');\n"
js_code += "        midtermTbody.innerHTML = '';\n"
js_code += "        const midtermTr = document.createElement('tr');\n"
js_code += "        midtermTr.innerHTML = `\n"
js_code += "            <td>${student.grades.midterm.total}</td>\n"
js_code += "            <td>${student.grades.midterm.questions[0]}</td>\n"
js_code += "            <td>${student.grades.midterm.questions[1]}</td>\n"
js_code += "            <td>${student.grades.midterm.questions[2]}</td>\n"
js_code += "            <td>${student.grades.midterm.questions[3]}</td>\n"
js_code += "            <td>${student.grades.midterm.questions[4]}</td>\n"
js_code += "        `;\n"
js_code += "        midtermTbody.appendChild(midtermTr);\n"
js_code += "\n"
js_code += "        // 期末成绩（置空）\n"
js_code += "        const finalTbody = document.getElementById('final-tbody');\n"
js_code += "        finalTbody.innerHTML = '';\n"
js_code += "        const finalTr = document.createElement('tr');\n"
js_code += "        finalTr.innerHTML = `\n"
js_code += "            <td>${student.grades.final.total}</td>\n"
js_code += "            <td>${student.grades.final.questions[0]}</td>\n"
js_code += "            <td>${student.grades.final.questions[1]}</td>\n"
js_code += "            <td>${student.grades.final.questions[2]}</td>\n"
js_code += "            <td>${student.grades.final.questions[3]}</td>\n"
js_code += "            <td>${student.grades.final.questions[4]}</td>\n"
js_code += "        `;\n"
js_code += "        finalTbody.appendChild(finalTr);\n"
js_code += "    }\n"
js_code += "}\n\n"
